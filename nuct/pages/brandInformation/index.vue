        ...
        <div class="brandInformation">
            <h6><span class="hStyle"></span>品牌基础数据和基础指标汇总</h6>
                <el-table :data="baseSummaryList" style="width: 100%">
                    ...
                    <el-table-column prop="population" label="人口（万人）" width="180"></el-table-column>
                    <el-table-column prop="profile" label="知名度（%）" width="180"></el-table-column>
                    <el-table-column prop="recognition" label="认知度（%）" width="180"></el-table-column>
                    <el-table-column prop="reputation" label="美誉度（%）" width="180"></el-table-column>
                    <el-table-column prop="loyalty" label="忠诚度（%）" width="180"></el-table-column>
                    <el-table-column prop="valuation" label="品牌信息量估值（万比特）" width="180"></el-table-column>
                </el-table>
            <h6><span class="hStyle"></span>品牌质量比值分析</h6>
                <el-table :data="brdQualityRatio" style="width: 100%">
                    ...
                    <el-table-column prop="specificValue" label="品牌信息质量比值" width="180"></el-table-column>
                </el-table>
  ...
  data () {
    return {
      baseSummaryList: [
                ...
                "region": "北京",
                "type": "城市总人口",
                "population": 1961.2400,
                "profile": 29.2700,
                "recognition": 15.24,
                "reputation": 33.85,
                "loyalty": 5.28,
                "valuation": 1071.39266,
                "orderNum": 1
                },
                {
                "id": 2,
